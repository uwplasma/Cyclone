...
from helper_functions import maximum_coil_radius
...
def planar_vector_list(tor_angle, pol_angle):
    ...
    '''
    return np.array([[sin(tor_angle),-cos(tor_angle),0],
                     [-cos(tor_angle)*sin(pol_angle),-sin(tor_angle)*sin(pol_angle),cos(pol_angle)]])
