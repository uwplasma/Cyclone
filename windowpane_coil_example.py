...
base_curves = create_windowpane_curves(ntoroidalcoils, npoloidalcoils, s.nfp, stellsym = True, R0 = R0, R1 = R1, max_radius_prop = max_radius_prop, order = order, fixed = True)
base_currents = [Current(1)*1e5 for i in range(len(base_curves))]
